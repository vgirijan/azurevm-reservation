...
exports.CloudServiceRoleInstancesImpl = void 0;
...
class CloudServiceRoleInstancesImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(roleInstanceName, resourceGroupName, cloudServiceName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const poller = await this.beginDelete(roleInstanceName, resourceGroupName, cloudServiceName, options);
     ...
     * @param options The options parameters.
     */
    async beginRestart(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestartAndWait(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const poller = await this.beginRestart(roleInstanceName, resourceGroupName, cloudServiceName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginReimage(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginReimageAndWait(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const poller = await this.beginReimage(roleInstanceName, resourceGroupName, cloudServiceName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginRebuild(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRebuildAndWait(roleInstanceName, resourceGroupName, cloudServiceName, options) {
        const poller = await this.beginRebuild(roleInstanceName, resourceGroupName, cloudServiceName, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.CloudServiceRoleInstancesImpl = CloudServiceRoleInstancesImpl;
