...
exports.CommunityGalleryImagesImpl = void 0;
...
class CommunityGalleryImagesImpl {
    ...
    async *listPagingPage(location, publicGalleryName, options, settings) {
        let result;
    ...
    async *listPagingAll(location, publicGalleryName, options) {
...
exports.CommunityGalleryImagesImpl = CommunityGalleryImagesImpl;
