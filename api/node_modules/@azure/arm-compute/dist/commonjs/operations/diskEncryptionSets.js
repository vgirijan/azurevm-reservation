...
exports.DiskEncryptionSetsImpl = void 0;
...
class DiskEncryptionSetsImpl {
    ...
    async *listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._listAssociatedResources(resourceGroupName, diskEncryptionSetName, options);
            let page = result.value || [];
            continuationToken = result.nextLink;
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
        ...
        while (continuationToken) {
            result = await this._listAssociatedResourcesNext(resourceGroupName, diskEncryptionSetName, continuationToken, options);
            continuationToken = result.nextLink;
            let page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listAssociatedResourcesPagingAll(resourceGroupName, diskEncryptionSetName, options) {
        for await (const page of this.listAssociatedResourcesPagingPage(resourceGroupName, diskEncryptionSetName, options)) {
            yield* page;
        }
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options) {
        const poller = await this.beginUpdate(resourceGroupName, diskEncryptionSetName, diskEncryptionSet, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, diskEncryptionSetName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, diskEncryptionSetName, options) {
...
exports.DiskEncryptionSetsImpl = DiskEncryptionSetsImpl;
