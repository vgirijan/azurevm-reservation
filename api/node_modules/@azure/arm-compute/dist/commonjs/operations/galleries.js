...
class GalleriesImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, galleryName, gallery, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, galleryName, gallery, options) {
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, galleryName, gallery, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, galleryName, gallery, options) {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, galleryName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, galleryName, options) {
...
exports.GalleriesImpl = GalleriesImpl;
