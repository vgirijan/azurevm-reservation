...
exports.GalleryImagesImpl = void 0;
...
class GalleryImagesImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, galleryName, galleryImageName, galleryImage, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, galleryName, galleryImageName, galleryImage, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, galleryName, galleryImageName, galleryImage, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, galleryName, galleryImageName, galleryImage, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, galleryName, galleryImageName, galleryImage, options) {
        const poller = await this.beginUpdate(resourceGroupName, galleryName, galleryImageName, galleryImage, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, galleryName, galleryImageName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, galleryName, galleryImageName, options) {
        const poller = await this.beginDelete(resourceGroupName, galleryName, galleryImageName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListByGalleryNext
...
exports.GalleryImagesImpl = GalleryImagesImpl;
