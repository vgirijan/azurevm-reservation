...
exports.LogAnalyticsImpl = void 0;
...
class LogAnalyticsImpl {
     ...
     */
    async beginExportRequestRateByInterval(location, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginExportRequestRateByIntervalAndWait(location, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginExportThrottledRequests(location, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginExportThrottledRequestsAndWait(location, parameters, options) {
        const poller = await this.beginExportThrottledRequests(location, parameters, options);
        return poller.pollUntilDone();
    }
}
exports.LogAnalyticsImpl = LogAnalyticsImpl;
