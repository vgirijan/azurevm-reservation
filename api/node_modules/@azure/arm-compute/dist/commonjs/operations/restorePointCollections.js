...
exports.RestorePointCollectionsImpl = void 0;
...
class RestorePointCollectionsImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, restorePointCollectionName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, restorePointCollectionName, options) {
        const poller = await this.beginDelete(resourceGroupName, restorePointCollectionName, options);
...
exports.RestorePointCollectionsImpl = RestorePointCollectionsImpl;
