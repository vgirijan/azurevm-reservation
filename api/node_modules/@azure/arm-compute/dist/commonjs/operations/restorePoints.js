...
exports.RestorePointsImpl = void 0;
...
class RestorePointsImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreate(resourceGroupName, restorePointCollectionName, restorePointName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateAndWait(resourceGroupName, restorePointCollectionName, restorePointName, parameters, options) {
        const poller = await this.beginCreate(resourceGroupName, restorePointCollectionName, restorePointName, parameters, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, restorePointCollectionName, restorePointName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, restorePointCollectionName, restorePointName, options) {
        const poller = await this.beginDelete(resourceGroupName, restorePointCollectionName, restorePointName, options);
        return poller.pollUntilDone();
    }
}
exports.RestorePointsImpl = RestorePointsImpl;
