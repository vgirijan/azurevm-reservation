...
exports.SharedGalleryImageVersionsImpl = void 0;
...
class SharedGalleryImageVersionsImpl {
    ...
    async *listPagingPage(location, galleryUniqueName, galleryImageName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(location, galleryUniqueName, galleryImageName, continuationToken, options);
            continuationToken = result.nextLink;
            let page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(location, galleryUniqueName, galleryImageName, options) {
        for await (const page of this.listPagingPage(location, galleryUniqueName, galleryImageName, options)) {
            yield* page;
        }
    }
    /**
...
exports.SharedGalleryImageVersionsImpl = SharedGalleryImageVersionsImpl;
