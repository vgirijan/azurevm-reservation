...
exports.SharedGalleryImagesImpl = void 0;
...
class SharedGalleryImagesImpl {
    ...
    async *listPagingPage(location, galleryUniqueName, options, settings) {
        let result;
    ...
    async *listPagingAll(location, galleryUniqueName, options) {
...
exports.SharedGalleryImagesImpl = SharedGalleryImagesImpl;
