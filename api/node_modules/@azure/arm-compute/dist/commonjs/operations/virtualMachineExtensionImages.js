...
exports.VirtualMachineExtensionImagesImpl = void 0;
...
class VirtualMachineExtensionImagesImpl {
    ...
    get(location, publisherName, typeParam, version, options) {
        return this.client.sendOperationRequest({ location, publisherName, typeParam, version, options }, getOperationSpec);
    }
}
exports.VirtualMachineExtensionImagesImpl = VirtualMachineExtensionImagesImpl;
