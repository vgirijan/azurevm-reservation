...
exports.VirtualMachineScaleSetExtensionsImpl = void 0;
...
class VirtualMachineScaleSetExtensionsImpl {
    ...
    async *listPagingPage(resourceGroupName, vmScaleSetName, options, settings) {
        let result;
    ...
    async *listPagingAll(resourceGroupName, vmScaleSetName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options) {
        const poller = await this.beginUpdate(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, vmScaleSetName, vmssExtensionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, vmScaleSetName, vmssExtensionName, options) {
        const poller = await this.beginDelete(resourceGroupName, vmScaleSetName, vmssExtensionName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
exports.VirtualMachineScaleSetExtensionsImpl = VirtualMachineScaleSetExtensionsImpl;
