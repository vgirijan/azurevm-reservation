...
import { DiskRestorePoint, DiskRestorePointListByRestorePointOptionalParams, DiskRestorePointGetOptionalParams, DiskRestorePointGetResponse, GrantAccessData, DiskRestorePointGrantAccessOptionalParams, DiskRestorePointGrantAccessResponse, DiskRestorePointRevokeAccessOptionalParams } from "../models/index.js";
/** Class containing DiskRestorePointOperations operations. */
export declare class DiskRestorePointOperationsImpl implements DiskRestorePointOperations {
    ...
    private listByRestorePointPagingPage;
    private listByRestorePointPagingAll;
    /**
     * Lists diskRestorePoints under a vmRestorePoint.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param restorePointCollectionName The name of the restore point collection that the disk restore
...
//# sourceMappingURL=diskRestorePointOperations.d.ts.map